...
$social_skin_url = str_replace(G5_PATH, G5_URL, get_social_skin_url());
?>
<div class="p-3 border border-teal-200 mt-2">
    <div class="login-sns sns-wrap-32 sns-wrap-over my-1" id="sns_register">
        <h2 class="font-semibold">SNS 계정으로 가입</h2>
